		...
		<tbody>
			...
			<tr>
				...
				<td style="text-align:center;">
					...
					<input style='font-size: 35px; color:black; height: 50px; font-weight:bold;' type="number" name="input_voto_bn" id="input_voto_bn" placeholder="" class="input_voto form-control" value="{{$votos_presidenciales_r->blancos}}" pattern="[0-9]{6,9}" onkeydown="return event.keyCode !== 69"  required/>
				</td>
				<td>
					<button type="button" class="btn_blanco_nulo btn btn-default btn-lg"><i class="fa fa-fw fa-save"></i> Guardar</button>
				</td>
			...
			<td style="text-align:center;">
				<input type="hidden" name="" id="blanco_nulo" value="NULO">
				<input type="hidden" name="" id="id_votos_presidenciales_r" value="{{$votos_presidenciales_r->id_votos_presidenciales_r}}">
				<input style='font-size: 35px; color:black; height: 50px; font-weight:bold;' type="number" name="input_voto_bn" id="input_voto_bn" placeholder="" class="input_voto form-control" value="{{$votos_presidenciales_r->nulos}}" pattern="[0-9]{6,9}" onkeydown="return event.keyCode !== 69"  required/>
			</td>
			<td>
				<button type="button" class="btn_blanco_nulo btn btn-default btn-lg"><i class="fa fa-fw fa-save"></i> Guardar</button>
			</td>
