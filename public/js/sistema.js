$(document).ready(function () {
  ...
  if (document.getElementById("clock")) {
    ...
    var countDownDate = new Date("Aug 17, 2025 00:00:01").getTime();
...
function verinfo_mesas(id, form) {
  ...
  if (form == 20) { var miurl = urlraiz + "/form_votar_presidencial_subir_imagen_emergencia/" + id + ""; }
  if (form == 21) { var miurl = urlraiz + "/form_votar_uninominal_subir_imagen_emergencia/" + id + ""; }
