                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="number" name="" id="partido_{{$partido->id_partido}}" min="0" value="{{$mesa->votos_presidenciales->where('id_partido',$partido->id_partido)->pluck('validos')->first()}}" style='width: 80px;'>
                                </div>
                                @else
                                <div class="form-group" style="text-align:center">
                            ...
                            <td>
                                <div class="form-group" style="text-align:center">
                                    <input type="number" name="" id="blancos" min="0" value="{{$mesa->votos_presidenciales_r->where('id_mesa',$mesa->id_mesa)->pluck('blancos')->first()}}" style='width: 80px;'>
                                </div>
                            </td>
                            <td>
                                <div class="form-group" style="text-align:center">
                                    <input type="number" name="" id="nulos" min="0" value="{{$mesa->votos_presidenciales_r->where('id_mesa',$mesa->id_mesa)->pluck('nulos')->first()}}" style='width: 80px;'>
                                </div>
                            </td>
                            @else
                            <td>
