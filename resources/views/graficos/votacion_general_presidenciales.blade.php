...
{{-- 
	...
	<div class="box box-primary">
		<div class="box-body">
			<div class="form-group">
				...
				<select class="form-control input-lg" id="distrito" onchange="activar_presidenciales()">
	...
	<div class="box box-primary">
		<a href="javascript:void(0);" onclick="refrescar_votos();">
			...
			<h3 class="box-title" style="color:white">Votos Presidenciales - Distrito</h3>
...
<script>
function activar_presidenciales() {
	// alertify.success('hola');
	var distrito = document.getElementById("distrito").value;
	var url = "{{url('presidenciales_por_distrito')}}";
